...
<head>
    ...
    <!-- ico font -->
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resource/icon/icofont/css/icofont.css">
    <!-- Style.css -->
...
%>
                                                            ...
                                                            <c:otherwise>
                                                            <td><a href="/admin/students/list?page=${i}">${i}</a></td>
                                                            </c:otherwise>
                                                            </c:choose>
                                                            </c:forEach>
                                                        </table>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/jquery/jquery.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/jquery-ui/jquery-ui.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/popper.js/popper.min.js"></script>
...
<!-- modernizr js -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/modernizr/modernizr.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/resource/js/modernizr/css-scrollbars.js"></script>
<!-- classie js -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/classie/classie.js"></script>
<!-- Custom js -->
