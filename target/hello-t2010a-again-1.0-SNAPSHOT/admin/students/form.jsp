                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="<%=url%>" method="post" name="myform">
                                                        <div class="form-group row">
                                                            <div class="col-sm-10">
                                                                    <input type="text" name="rollNumber" required placeholder="Please enter roll number" class="form-control form-control-round"
                                                                    value="<%=student.getRollNumber()%>" <%=action == 2 ? "readonly":""%>>
                                                            </div>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="fullName" required placeholder="Please enter full name" class="form-control form-control-round"
                                                                       value="<%=student.getFullName()%>">
                                                            </div>
                                                            <div class="col-sm-10">
                                                                <input type="email" name="email" required placeholder="Please enter email" class="form-control form-control-round"
                                                                       value="<%=student.getEmail()%>">
                                                            </div>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="phone" required placeholder="Please enter phone number" class="form-control form-control-round"
                                                                       value="<%=student.getPhone()%>">
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <input type="date" name="birthday" required class="form-control form-control-round"
                                                                       value="<%=student.getDobString()%>">
                                                            </div>
                                                            <div>
                                                            </div>
                                                            <input type="submit" class="btn btn-info btn-round" value="Save">
